...
\[
  \texttt{newEstimate} \leftarrow \texttt{oldEstimate} + \texttt{stepSize}[\texttt{target} - \texttt{oldEstimate}]
\]
...
Q-Learning: \url{https://www.youtube.com/watch?v=0iqz4tcKN58}
...
Q-Learning
\[
  Q^{\text{new}}(s_{t},a_{t}) \leftarrow \underbrace{Q(s_{t},a_{t})}_{\text{old value}} + \underbrace{\alpha}_{\text{learning rate}} \cdot  \overbrace{\bigg( \underbrace{\underbrace{r_{t}}_{\text{reward}} + \underbrace{\gamma}_{\text{discount factor}} \cdot \underbrace{\max_{a}Q(s_{t+1}, a)}_{\text{estimate of optimal future value}}}_{\text{new value (temporal difference target)}} - \underbrace{Q(s_{t},a_{t})}_{\text{old value}} \bigg) }^{\text{temporal difference}} 
\]
