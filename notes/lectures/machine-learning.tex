...
\subsection{Alternative to regression: $k$-nearest neighbors classifier}
...
\paragraph{Optimal value function} The \textbf{optimal value function} $V^{\star}(s) $ is the maximum value function over all policies
\[
